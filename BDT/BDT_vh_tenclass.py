...
train_w_df.loc[train_w_df.proc == 'QQ2HLNU_PTV_75_150','weight'] = (train_w_df[train_w_df['proc'] == 'QQ2HLNU_PTV_75_150']['weight'] * vh1_sum_w / vh3_sum_w)
train_w_df.loc[train_w_df.proc == 'QQ2HLNU_PTV_150_250_0J','weight'] = (train_w_df[train_w_df['proc'] == 'QQ2HLNU_PTV_150_250_0J']['weight'] * vh1_sum_w / vh4_sum_w)
train_w_df.loc[train_w_df.proc == 'QQ2HLNU_PTV_150_250_GE1J','weight'] = (train_w_df[train_w_df['proc'] == 'QQ2HLNU_PTV_150_250_GE1J']['weight'] * vh1_sum_w / vh5_sum_w)
train_w_df.loc[train_w_df.proc == 'QQ2HLNU_PTV_GT250','weight'] = (train_w_df[train_w_df['proc'] == 'QQ2HLNU_PTV_GT250']['weight'] * vh1_sum_w / vh6_sum_w)
train_w_df.loc[train_w_df.proc == 'QQ2HLL_PTV_0_75','weight'] = (train_w_df[train_w_df['proc'] == 'QQ2HLL_PTV_0_75']['weight'] * vh1_sum_w / vh7_sum_w)
train_w_df.loc[train_w_df.proc == 'QQ2HLL_PTV_75_150','weight'] = (train_w_df[train_w_df['proc'] == 'QQ2HLL_PTV_75_150']['weight'] * vh1_sum_w / vh5_sum_w)
train_w_df.loc[train_w_df.proc == 'QQ2HLL_PTV_150_250_0J','weight'] = (train_w_df[train_w_df['proc'] == 'QQ2HLL_PTV_150_250_0J']['weight'] * vh1_sum_w / vh6_sum_w)
train_w_df.loc[train_w_df.proc == 'QQ2HLL_PTV_150_250_GE1J','weight'] = (train_w_df[train_w_df['proc'] == 'QQ2HLL_PTV_150_250_GE1J']['weight'] * vh1_sum_w / vh7_sum_w)
train_w_df.loc[train_w_df.proc == 'QQ2HLL_PTV_GT250','weight'] = (train_w_df[train_w_df['proc'] == 'QQ2HLL_PTV_GT250']['weight'] * vh1_sum_w / vh7_sum_w)
