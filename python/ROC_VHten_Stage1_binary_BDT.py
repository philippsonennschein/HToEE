...
BDT_cm = np.loadtxt('csv_files/VH_BDT_binary_cm', delimiter = ',')
NN_cm = np.loadtxt('csv_files/VH_NN_binary_cm', delimiter = ',')
Cuts_cm = np.loadtxt('csv_files/VH_Cuts_binary_cm', delimiter = ',')
...
for i in range(len(signal)):
    ...
    fig, ax = plt.subplots()
    #BDT
    BDT_name_fpr = 'csv_files/VH_BDT_binary_fpr_' + signal[i]
    ...
    BDT_name_tpr = 'csv_files/VH_BDT_binary_tpr_' + signal[i]
    ...
    #NNs
    NN_name_fpr = 'csv_files/VH_NN_binary_fpr_' + signal[i]
    ...
    NN_name_tpr = 'csv_files/VH_NN_binary_tpr_' + signal[i]
    ...
    #Cuts
    Cut_name_fpr = 'csv_files/VH_Cuts_binary_fpr_' + signal[i]
    ...
    Cut_name_tpr = 'csv_files/VH_Cuts_binary_tpr_' + signal[i]
    ...
    name = 'plotting/BDT_VH_binary_Multi_ROC_curve' + signal[i]
