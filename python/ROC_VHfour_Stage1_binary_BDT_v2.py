...
BDT_cm = np.loadtxt('csv_files/VH_fourclass_BDT_cm', delimiter = ',')
NN_cm = np.loadtxt('csv_files/VH_fourclass_NN_cm', delimiter = ',')
Cuts_cm = np.loadtxt('csv_files/VH_fourclass_Cuts_cm', delimiter = ',')
