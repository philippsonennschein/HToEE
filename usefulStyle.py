...
def drawCMS(onTop=False, text='Simulation preliminary'):
    ...
    latex.DrawLatex(0.248, 0.85 if not onTop else 0.91, "CMS")
    #latex.DrawLatex(0.118, 0.85 if not onTop else 0.91, "CMS")
    latex.SetTextSize(0.0414)
    latex.SetTextFont(52)
    #latex.DrawLatex(0.18, 0.85 if not onTop else 0.91, text)
    latex.DrawLatex(0.318, 0.85 if not onTop else 0.91, text)

def drawSmallCMS(onTop=False, x1=0.13, x2=0.20, text='Simulation preliminary'):
    latex = TLatex()
    latex.SetNDC()
    latex.SetTextFont(62)
    latex.SetTextSize(0.0414)
    latex.DrawLatex(x1, 0.85 if not onTop else 0.91, "CMS")
    #latex.DrawLatex(0.118, 0.85 if not onTop else 0.91, "CMS")
    latex.SetTextSize(0.0414)
    latex.SetTextFont(52)
    #latex.DrawLatex(0.18, 0.85 if not onTop else 0.91, text)
    latex.DrawLatex(x2, 0.85 if not onTop else 0.91, text)
